...
const Navbar = () => {
  return (
    <nav className="fixed bottom-8 left-1/2 z-50 flex -translate-x-1/2 flex-row items-stretch gap-1 text-kami desktop:bottom-12">
      ...
      <Link
        className="k-interactable-simple k-glassy flex rounded-md bg-katsu px-4 font-medium lowercase transition-all"
        to="/posts"
      >
      ...
      <button
        className="k-interactable-simple k-glassy flex w-12 rounded-md bg-katsu font-medium lowercase transition-all"
        to="/"
      >
