...
- <span class="text-kami" style="background-color:#3870A5">
    national
  </span> <span class="!text-katsu" style="background-color:#FFEC85">
    gold
  </span> <span class="!text-katsu" style="background-color:#F5FFE8">
    math
...
- <span class="!text-katsu" style="background-color:#7FD4D5">
    state
  </span> <span class="!text-katsu" style="background-color:#FFEC85">
    gold
  </span> <span class="!text-katsu" style="background-color:#F5FFE8">
